...
if (allPresent) {
  ...
  console.log("You can now run: node test-login.js or node test-vauto.js");
} else {
  console.log(
    "\n❌ Please set the missing environment variables in your .env file"
  );
  console.log("Example .env file content:");
  console.log("CARMAX_EMAIL=your_email@example.com");
  console.log("CARMAX_PASSWORD=your_password");
